...
$('#quick-contact-form-result').hide();
    ...
    $.ajax({
        ...
        success: function(data) {
            $("#quick-contact-form").fadeOut(500, function(){
                $('#quick-contact-form-result').text(data).fadeIn(500);
            });
            console.log("Mail Sent");
        },
        error: function() {
            $('#quick-contact-form-result').text("There was an error submitting your form, please verify fields and try again.").fadeIn(500);
